...
import Secao16.ChessGame.chess.ChessPosition;
...
public class UI {
    ...
    //The black pieces will turn yellow because of the black color of the terminal background
    ...
    private static void printCapturedPieces(List<ChessPiece> captured) {
        //Performs filter of the list all the pieces that are of white or black color
